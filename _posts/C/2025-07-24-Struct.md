...
## Typedef trong c
typedef trong C dùng để đặt tên mới (alias) cho một kiểu dữ liệu có sẵn, giúp code ngắn gọn, dễ đọc và dễ bảo trì hơn.

Nó không tạo ra kiểu dữ liệu mới, mà chỉ là một "bí danh" cho kiểu có sẵn.
 **Cú pháp**:
 ```c
